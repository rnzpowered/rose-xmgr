...
def upgrade() -> None:
    ...
    if bind.engine.name == "mysql":
        ...
        op.alter_column("inbounds", "tag", type_=sa.String(length=256, collation="utf8mb4_bin"), nullable=False)
        op.alter_column(
        ...
        op.alter_column("hosts", "inbound_tag", type_=sa.String(length=256, collation="utf8mb4_bin"), nullable=False)
        op.alter_column(
...
def downgrade() -> None:
    ...
    if bind.engine.name == "mysql":
        ...
        op.alter_column("inbounds", "tag", type_=sa.String(length=256, collation="utf8mb4_general_ci"), nullable=False)
        op.alter_column(
            "template_inbounds_association",
            "inbound_tag",
        ...
        op.alter_column(
            "hosts", "inbound_tag", type_=sa.String(length=256, collation="utf8mb4_general_ci"), nullable=False
        )
        op.alter_column(
            "exclude_inbounds_association",
            "inbound_tag",
